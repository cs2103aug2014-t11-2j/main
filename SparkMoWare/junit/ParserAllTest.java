...
public class ParserAllTest {
	...
	public void test() {
        ...
        assertEquals("09/09/34", ParserTestDriver.testExtractEndDate("add 09/09/34"));

		//confirm method returns second date input
        assertEquals("02/03/45", ParserTestDriver.testExtractEndDate("add 09/09/1234 2/3/45"));
        ...
        assertEquals("09/09/34", ParserTestDriver.testExtractStartDate("add 09/09/34 2/3/45"));
		...
		//test for length of string !=6
		assertFalse(ParserTestDriver.testDateFormatValid("1234567"));
		assertFalse(ParserTestDriver.testDateFormatValid("12345"));
		...
		//single tentative
        assertEquals("[09/08/34]", ParserTestDriver.testExtractTentativeDates("09/08/34 0900"));
		
		//two tentatives
        assertEquals("[09/08/34, 02/03/34]", ParserTestDriver.testExtractTentativeDates("09/08/34 0900 02/03/34 0800"));
		...
		//Test forClear
		assertEquals("between", ParserTestDriver.testforClear("clear between 09/08/20 10/8/20"));
		assertEquals("on", ParserTestDriver.testforClear("clear on 09/08/20"));
		assertEquals("before", ParserTestDriver.testforClear("clear before 09/08/20"));
        ...
        assertEquals("INVALID_FORMAT~0~default~31/10/14~2359"
                + "~31/10/14~2359~DEFAULT~NIMPT"
        ...
        assertEquals("ADD~0~buy fish~default~default"
                + "~31/10/14~2359~TASK~NIMPT"
                + "~false~default~null~null",
                ParserTestDriver.testInputIsAdd("Add buy fish 31/10/14 2359"));

        //ZY 2
        assertEquals("ADD~0~buy fish~31/10/14~2359"
                + "~01/10/15~2359~APPT~NIMPT"
                + "~false~default~null~null",
        ...
        assertEquals("ADD~0~buy chicken~09/09/34~0900"
                + "~02/03/45~0800~APPT~IMPT"
                + "~false~default~null~null",
        ...
        assertEquals("ADD~0~buy fish~31/10/14~2300"
                + "~31/10/14~2359~APPT~NIMPT"
                + "~false~default~null~null",
        ...
        assertEquals("CLEAR~0~default~29/08/14~default"
        ...
        //generalised test case
        assertEquals("CONFIRM~1~default~15/10/14~1300"
                + "~15/10/14~1500~DEFAULT~NIMPT"
		...
		assertEquals("TENTATIVE~0~consultation~default~default"
				...
				+ "~true~default~[12/08/14]~[0900]", ParserTestDriver.testInputIsTentative("Tentative consultation 12/8/14 0900"));
		
		//more than one tentative
		assertEquals("TENTATIVE~0~consultation~default~default"
				+ "~default~default~TNTV~NIMPT"
				+ "~true~default~[12/08/14, 01/09/14, 01/09/14]"
		...
		//generalised test  case
		assertEquals("DELETE~1~default~default~default"
				+ "~default~default~DEFAULT~NIMPT"
				+ "~false~default~null~null", ParserTestDriver.testInputIsDelete("delete 1"));
		...
		assertEquals("SEARCH~0~default~default~default"
				+ "~default~default~DEFAULT~NIMPT"
				+ "~false~10/08/14~null~null", ParserTestDriver.testInputIsSearch("search 10/8/14"));
