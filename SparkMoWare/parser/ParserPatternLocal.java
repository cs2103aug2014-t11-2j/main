...
public class ParserPatternLocal {
	...
	protected static Pattern idPattern = Pattern.compile("(([0-2][0-9][0-1][0-9][0-9]{4}).([0-9]?[0-9]?[0-9]?[0-9]?))|"
													   + "(([0-2][0-9][0-1][0-9][0-9]{4})-([0-9]?[0-9]?[0-9]?[0-9]?))|"
													   + "(([0-2][0-9][0-1][0-9][0-9]{4})_([0-9]?[0-9]?[0-9]?[0-9]?))|"
													   + "(([0-2][0-9][0-1][0-9][0-9]{4})/([0-9]?[0-9]?[0-9]?[0-9]?))");
													   //+ "(([0-2][0-9][0-1][0-9][0-9]{4})([0-9]?[0-9]?[0-9]?[0-9]?))"
